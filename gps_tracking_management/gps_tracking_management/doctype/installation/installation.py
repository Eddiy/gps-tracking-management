...
def transfer_device(parent, serial, t_warehouse, s_warehouse, company, sim_no):
    ...
    tracker_entry.append("items", {"item_code": "Tracker", "t_warehouse": t_warehouse, "s_warehouse": s_warehouse, "serial_no":serial,  "qty": 1.000, "uom": "Nos", "conversion_factor":  1.000000 , "stock_uom": "Nos",   "transfer_qty": 1 })
    sim_entry.append("items", {"item_code": "GSM", "t_warehouse": t_warehouse, "s_warehouse": s_warehouse, "serial_no":sim_no,  "qty": 1.000, "uom": "Nos", "conversion_factor":  1.000000 , "stock_uom": "Nos",   "transfer_qty": 1 })
...
def get_warehouse(name):
    ...
    warehouse=frappe.db.get_value("Warehouse", {"warehouse_name": technician})
    return warehouse
@frappe.whitelist()
